  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16">
      ...
      <section className="mb-10 space-y-4 text-sm leading-relaxed rounded-3xl p-6" style={{ background: "var(--surface)", border: "1px solid var(--border)", color: "var(--muted)" }}>
        ...
        <p>
          The scores are satirical. The ratings are generated by a system that assigns absurdist
          labels based on randomized beauty pseudoscience. The point is to be funny, not accurate.
